...
ComacNewVersionDlg::ComacNewVersionDlg(CATDialog* iParent, const CATString& iName)
...
// Begin of User Code
CATDlgEditor* ComacNewVersionDlg::GetEditor(int iCtrlID)
{
...
//
//CATDlgCheckButton* ComacNewVersionDlg::GetCheckButton(int iCtrlID)
//{
