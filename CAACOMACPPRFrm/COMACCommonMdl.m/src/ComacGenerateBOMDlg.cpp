...
ComacGenerateBOMDlg::ComacGenerateBOMDlg(CATDialog* iParent, const CATString& iName)
...
ComacGenerateBOMDlg::~ComacGenerateBOMDlg()
{
...
void ComacGenerateBOMDlg::Build()
{
	int style = 0;
...
// Begin of User Code
CATDlgEditor* ComacGenerateBOMDlg::GetEditor(int iCtrlID)
{
	CATDlgEditor* pEditor = NULL;

	switch (iCtrlID)
	{
	case ID_SelectCADEditor:
		pEditor = _Editor1;
		break;
...
/*
CATDlgRadioButton* ComacGenerateBOMDlg::GetRadioButton(int iCtrlID)
{
...
CATDlgCombo* ComacGenerateBOMDlg::GetCombo(int iCtrlID)
{
