...
#ifndef ComacNewVersionDlg_h
#define ComacNewVersionDlg_h
...
enum ComacNewVersionDlg_ControlID
{
...
class  ComacNewVersionDlg : public CATDlgDialog {
	DeclareResource(ComacNewVersionDlg, CATDlgDialog)

public:
	ComacNewVersionDlg(CATDialog * iParent, const CATString& iDialogName);
	virtual ~ComacNewVersionDlg();
	...
	// -----------------------------------
	ComacNewVersionDlg(ComacNewVersionDlg &);
	ComacNewVersionDlg& operator=(ComacNewVersionDlg&);
