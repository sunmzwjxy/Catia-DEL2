...
ComacInsertSpecialPartOrGasketDlg::ComacInsertSpecialPartOrGasketDlg(CATDialog* iParent, const CATString& iName)
...
ComacInsertSpecialPartOrGasketDlg::~ComacInsertSpecialPartOrGasketDlg()
{
...
void ComacInsertSpecialPartOrGasketDlg::Build()
{
	int style = 0;
	...
	_Combo4->SetGridConstraints(1, 1, 1, 1, 0 | CATGRID_LEFT | CATGRID_RIGHT | CATGRID_TOP);
	_Combo4->SetVisibleTextWidth(20);
...
// Begin of User Code
CATDlgEditor* ComacInsertSpecialPartOrGasketDlg::GetEditor(int iCtrlID)
{
	CATDlgEditor* pEditor = NULL;

	switch (iCtrlID)
	{
	case ID_SelectCreateAssemblyEditor:
		pEditor = _Editor1;
		break;
	case ID_ProcessPartNoEditor:
		pEditor = _Editor2;
		break;
	case ID_ProcessPartNameEditor:
		pEditor = _Editor3;
		break;
	default:
		break;
...
//CATDlgRadioButton* ComacInsertSpecialPartOrGasketDlg::GetRadioButton(int iCtrlID)
//{
...
CATDlgCombo* ComacInsertSpecialPartOrGasketDlg::GetCombo(int iCtrlID)
{
