...
class ExportedByCUS_UtilFunc CUSCAAUtilService:public CATBaseUnknown
{
public:
...
// fengy 2022.1.12  new
static CATListOfCATUnicodeString GetComboValueList(CATDlgCombo* ipCombo, CATUnicodeString sNlsFileName, CATUnicodeString sNlsKeyValue, CATUnicodeString splitChar);
...
static CATUnicodeString GetServerURL();
